...
public class RegisterModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
    {
        ...
        ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            ...
            user.Role = Enum.Parse<RoleType>(Input.Role);
        ...
        // Sign in the user and redirect to the requested URL (or home)
        _logger.LogInformation("User created a new account. Signing in and redirecting. ReturnUrl: {ReturnUrl}", returnUrl);
